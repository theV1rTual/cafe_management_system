...
export class ManageOrderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var temp = {
      ...
      contactNumber: "7078856426",
      paymentMethod: "Credit",
      totalAmount: "123",
      productDetails: "[{\"id\": 1, \"name\": \"Test\", \"price\": 123, \"total\": 1, \"category\": \"Cake\", \"quantity\": \"1\"}]"
    }

    this.billService.generateReport(temp).subscribe((res:any) => {
      console.log(res);
    })
  ...
  validateSubmit() {
    ...
    !(this.manageOrderForm.controls['email'].valid) || !(this.manageOrderForm.controls['email'].valid)) {
      return true
    } else {
      return false
    }
  ...
  handleSubmitAction() {
    ...
    var data = {
      ...
      productDetails: "[{\"id\": 1, \"name\": \"Red Cofjgnsdlkgghsjhhfee\", \"price\": 9449, \"total\": 96874, \"category\": \"Coffee\", \"quantity\": \"1\"}]"
